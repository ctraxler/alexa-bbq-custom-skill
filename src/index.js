...
*/
                ...
                iotData.getThingShadow(params, function(err, data) {
                       ...
                       //Handle the error here
                            ...
                            responseString = "The temperature of the " + str " is " + data.payload.state.reported.bbq + "degrees";
                        }
                    }
            ...
            case 'UPPER LEVEL':
               ...
               iotData.getThingShadow(params, function(err, data) {
                       ...
                       //Handle the error here
                            ...
                            log("Data back from shadow", data);
                            responseString = "The " + str + " food temperature is " + data.payload.state.reported.bbq + "degrees";
            ...
            case 'UPPER ALARM':
               iotData.getThingShadow(params, function(err, data) {
                       ...
                       //Handle the error here
                            ...
                            log("Data back from shadow", data);
                            responseString = "The " + str + " is set for " + data.payload.state.reported.bbq + "degrees";
